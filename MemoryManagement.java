/** The class MemoryManagement converts virtual memory addresses to physical memory addresses using a page table.
 * It reads in a text file with a sequence of binary virtual addresses and converts them to binary physical addresses. 
 * It then converts these to hexadecimal format and writes them to a file called output.txt.
 * @author Tamara Ringas.
*/
